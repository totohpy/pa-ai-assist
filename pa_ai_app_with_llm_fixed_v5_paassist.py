...
"""
        ...
        # --- NEW: เพิ่ม Slider สำหรับปรับจำนวนผลลัพธ์ ---
        ...
        if st.button("ค้นหาประเด็นที่ใกล้เคียง", type="primary", key="search_button_fix"):
            ...
            # --- MODIFIED: ส่งค่าจาก slider ไปยังฟังก์ชัน ---
...
"""
    ...
    # --- MODIFIED: เปลี่ยนมาใช้ Expander ตามคำแนะนำ ---
...
with tab_chatbot:
    ...
    with st.expander("อัปโหลดเอกสารเพิ่มเติม (PDF, TXT, CSV)"):
        st.info("ข้อมูลจากไฟล์ที่คุณอัปโหลดจะถูกนำไปรวมกับเอกสารในคลังข้อมูล เพื่อใช้เป็นเนื้อหาในการตอบคำถาม")
    ...
    # --- ส่วนที่เหลือของโค้ดทำงานเหมือนเดิม ไม่มีการเปลี่ยนแปลง ---
...
1.  **ข้อมูลจากเอกสารภายใน (Primary Source):** นี่คือเนื้อหาที่ดึงมาจากเอกสารในคลังข้อมูลของระบบ จงยึดข้อมูลนี้เป็นหลักในการตอบคำถามเสมอ
...
- หากข้อมูลในเอกสารขัดแย้งกับข้อมูลทั่วไป ให้ยึดข้อมูลในเอกสารเป็นหลักและอาจกล่าวถึงความขัดแยย้งนั้น
