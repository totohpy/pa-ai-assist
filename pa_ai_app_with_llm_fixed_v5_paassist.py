...
@media (max-width: 768px) {
    /* ต้องใช้ class ตาม Streamlit version ที่รันอยู่ */
...
# แก้ไข Syntax Error: ตรวจสอบให้แน่ใจว่ามี ')' ปิดท้ายฟังก์ชัน st.tabs
...
]) # <-- บรรทัดนี้ (Line 76) ต้องมีวงเล็บปิดของฟังก์ชัน st.tabs()
...
"""
        ...
        with c_query_area:
            ...
            # ใช้ st.session_state.get() เพื่อให้แน่ใจว่าค่าถูกเก็บใน session state ก่อน
            if "issue_query_text" not in st.session_state:
