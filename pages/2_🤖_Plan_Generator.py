...
def generate_docx_report(data):
    ...
    current_section.page_width = new_width; current_section.page_height = new_height
    ...
    sigs = data["signatures"]; sig_table = doc.add_table(rows=1, cols=3); sig_table.style = 'Table Grid'
