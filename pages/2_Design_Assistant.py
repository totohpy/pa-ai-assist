...
# This sidebar is empty to allow the main Home.py to control its base content
with st.sidebar:
    pass
...
st.markdown(
    ...
    [data-testid="stSidebar"] { background-color: #e0f2f1; width: 350px !important; }
    ...
    div[data-testid="stSidebarNav"] a[aria-current="page"] {
        background-color: #009688; color: #FFFFFF !important;
        font-weight: 600; border: 1px solid #00796b;
    }
    /* Original Tab Styling for this page */
...
# --- All Tab Content (No changes needed) ---
# ... (The rest of the file content for each tab remains exactly the same) ...
