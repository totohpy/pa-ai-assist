...
def init_state():
    ...
    if 'doc_context_local' not in ss:
        # This part for loading local documents is commented out as it might not be needed by all users
        # and requires a 'Doc' folder.
...
with tab_plan:
    ...
    # ... (โค้ดส่วนนี้ยาวและไม่เปลี่ยนแปลง จึงย่อไว้)
    pass
