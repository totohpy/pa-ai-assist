...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown('<p style="font-family: \'Kanit\', sans-serif;"><span style="color: red; font-weight: bold;">A</span>udit <span style="color: red; font-weight: bold;">I</span>ntelligence Team</p>', unsafe_allow_html=True)
