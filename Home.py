...
st.markdown(
    "<h2 style='font-style: italic; color: #2baf2b; font-size: 24px'> ⚒ Achieve More, Faster. Your Intelligent Efficiency Tools  ᯓ★ </h3>",
    unsafe_allow_html=True
)
st.write("")
st.write("")
...
st.markdown("---")
st.info("⚙️ การใช้ฟีเจอร์ AI อาจทำผิดพลาดได้ ดังนั้น โปรดตรวจสอบคำตอบอีกครั้ง  และเป็นการแสดงผล ณ ขณะใช้งานไม่มีการจัดเก็บข้อมูลไว้ในระบบ")
