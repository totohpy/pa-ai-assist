    ...
    st.markdown(
        ...
        <a href="Audit_Design_Assistant" target="_self" class="feature-link">
            <div class="feature-box box-1">
                ...
                <p>แนะนำประเด็นที่ควรตรวจสอบ จากการวิเคราะห์ข้อมูลแผน, 6W2H, Flowchart Logic Model  และฐานข้อมูลข้อตรวจพบที่ผ่านมา</p>
            </div>
        </a>
        """,
        unsafe_allow_html=True
    ...
    st.markdown(
        ...
        <a href="PA_Assistant_Chat" target="_self" class="feature-link">
            <div class="feature-box box-3">
                ...
                <p>ผู้ช่วยอัจฉริยะที่สามารถถาม-ตอบข้อสงสัยจากคู่มือการปฏิบัติงาน คลังข้อมูลการตรวจสอบต่างๆ ช่วยสนับสนุนการทำงาน</p>
            </div>
        </a>
        """,
        unsafe_allow_html=True
